  ...
  <body class="animsition">
      ...
      <div id="menuzord" class="menuzord red" align="center">
        ...
        <ul class="menuzord-menu" align="center">
          ...
          <li class=""><a href="book"> MY REVELATIONS</a></li>
          <li class=""><a href="soil">SOIL</a></li>
          <li class=""><a href="masters/masters">MASTERS</a>
			<ul class="dropdown">
              <li><a href="masters/masters">Silo</a></li>
			  <li><a href="masters/fernando">Fernando</a></li>
			  <li><a href="masters/Mahesh">Mahesh Yogi</a></li>
			  <li><a href="masters/Andrew">Andrew Cohen</a></li>
			  <li><a href="masters/Ken">Ken Wilber</a></li>
			  <li><a href="masters/Mantak">Mantak chia</a></li>
			  <li><a href="masters/Thich">Thich nath hanh</a></li>
			  <li><a href="masters/Viktor">Viktor frankl</a></li>
          ...
          <li class=""><a href="testimonies/testimonies">TESTIMONIES</a></li>
      ...
      <div class="col-md-12">
        <h1 align="center" style="color:#2277BC; font-family: 'Metrophobic', sans-serif;">Contact Us</h1>
    ...
    <script>
       ...
       $("#contacts-submit").on('click', function(e){
         //e.preventDefault(); 
         var name=$.trim($("#exampleInputFirstName").val());
         ...
         if(name==""||name==null){
           $("#name").css('border-bottom','2px solid #f60f60');
           $("#name").fadeIn().fadeIn();  
           errCnt++;
         }else{
           $("#name").css('border-bottom','2px solid #CCCCCC');
         }
         if(email==""||email==null){
           $("#email").css('border-bottom','2px solid #f60f60');
           $("#email").fadeIn().fadeIn();
           errCnt++;
           ...
           $("#email").css('border-bottom','2px solid #CCCCCC');
         }
         if((isNaN(phone))||phone==""){
           $("#mobile").css('border-bottom','2px solid #f60f60');
           ...
           $("#mobile").css('border-bottom','2px solid #CCCCCC');
           }if(query==""||query==null){
             $("#enquiry").css('border-bottom','2px solid #f60f60');
             $("#enquiry").fadeIn().fadeIn();
             errCnt++;
         }else{
           $("#enquiry").css('border-bottom','2px solid #CCCCCC');
         }
